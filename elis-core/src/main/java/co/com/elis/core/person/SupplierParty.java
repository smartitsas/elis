...
public class SupplierParty<N extends PersonName> extends Person<N> {
    ...
    public SupplierParty(PersonType personType, N name, IdentityDocument identityDocument, PhysicalLocation physicalLocation, DIANCharacterization dianCharacterization, List<Contact> contacts) {
    ...
    public static class SupplierPartyBuilder<N extends PersonName, R extends RepresentationType> extends PersonBuilder<N, R, SupplierPartyBuilder<N, R>> {
        ...
        public SupplierParty<N> build() throws ElisCoreException {
            ...
            SupplierParty<N> supplier = new SupplierParty<>(personType, personName, identityDocument, physicalLocation, dianCharacterization, contacts);

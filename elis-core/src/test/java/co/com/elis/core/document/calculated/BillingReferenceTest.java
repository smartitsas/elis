...
public class BillingReferenceTest {
    ...
    public void multipleReferenceTest() throws ElisCoreException {
        ...
        var ref4 = new Reference("ORIG789", ReferenceType.ORDER_REFERENCE);
        var ref5 = new Reference("R001", ReferenceType.RECEIPT_REFERENCE);
        var ref6 = new Reference("OTH_EPS001", ReferenceType.PURCHASE_ORDER);
        ...
        var item = InvoiceItem.calculateAs()
                ...
                .setQuantity(10)
                .setUnits("BX")
                .setDescription("sample desciption")
                .getCalculatedResult();
        ...
        var invoice = software.calculateInvoiceAs()
                ...
                .addReferences(new Reference("OTH1", ReferenceType.PURCHASE_ORDER), new Reference("OTH1", ReferenceType.PURCHASE_ORDER))
                .addReferences(Arrays.asList(new Reference("OTH1", ReferenceType.PURCHASE_ORDER), new Reference("OTH1", ReferenceType.PURCHASE_ORDER)))
                .getCalculatedResult();
        ...
        assertThat(invoice.getOtherData().getReferences().getOfType(ReferenceType.PURCHASE_ORDER).get(0), is(ref6));

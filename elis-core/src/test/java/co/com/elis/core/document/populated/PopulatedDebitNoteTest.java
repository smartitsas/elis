...
public class PopulatedDebitNoteTest {
    ...
    public void startup() throws ElisCoreException {
        ...
        supplier = software.getPersonBuilder().createSupplierPartyAsJuridicPerson()
                ...
                .withPhysicalLocation(PhysicalLocation.createAs().withCountrySubdivision(subdivision).build())
                .withRegistrationAddress(PhysicalLocation.createAs().withCountrySubdivision(subdivision).build())
